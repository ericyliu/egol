...
import { cloneDeepWith, each, size, times, values } from 'lodash';
...
class Actor {
  ...
  constructor(world: World, brain?: brain.recurrent.RNN) {
    this.brainId = uuidv1();
    this.brain = brain || new brain.recurrent.RNN(config);
    this.world = world;
  }
